...
This is a proof-of-concept implementation of [Siphash2-4]() with 64-bit wide internal state registers.
...
3. Observe results in STDOUT, use `gtkwave` to open `siphash/Vsiphash_top.vcd`
